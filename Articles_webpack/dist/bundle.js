...
/******/ 	var hotCurrentHash = "de125506dde81f23e348"; // eslint-disable-line no-unused-vars
...
/******/ 	__webpack_require__.p = "D:\\Mavric\\FrontCamp\\FrontCamp\\Task1./dist/";
/******/
...
exports.API_CONSTANTS = API_CONSTANTS;
exports.APP_CONSTANTS = APP_CONSTANTS;
exports.arrayEndpoints = arrayEndpoints;
...
var _application = __webpack_require__(331);
...
function init() {
    application = new _application2.default();
}
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //import NewsRequester from './newsRequester';


var _article = __webpack_require__(332);

var _article2 = _interopRequireDefault(_article);

var _errorHandler = __webpack_require__(333);
    ...
    _createClass(Application, [{
        ...
        value: function _onButtonGetArticlePress() {
            ...
            new Promise(function (resolve) {
                __webpack_require__.e/* require.ensure */(0).then((function (require) {
                    resolve(__webpack_require__(338));
                }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
            }).then(function (NewsRequester) {
                var selectedValues = _this._getSelectedValues();
                var newsRequesterClass = NewsRequester.default;
                var newsRequester = new newsRequesterClass(selectedValues);
                newsRequester.requestNews().then(function (response) {
                    ...
                    if (articles && articles.length > 0) {
                        ...
                        articles.forEach(function (oneArticle, index) {
                            var article = new _article2.default(oneArticle);
        ...
        value: function _appendImageToArticle(aside, urlToImage, urlToArticle) {
            ...
            if (urlToImage) {
                ...
                img.src = _constants.APP_CONSTANTS.DEFAULT_IMG;
            }

            img.onerror = function (oEvent) {
                if (img.src !== _constants.APP_CONSTANTS.DEFAULT_IMG) {
                    img.src = _constants.APP_CONSTANTS.DEFAULT_IMG;
                }
            };
...
var ErrorHandler = function () {
    ...
    _createClass(ErrorHandler, [{
        ...
        value: function handleError(error) {
            ...
            if (message) {
                _constants.arrayEndpoints.arrayEndpoints.forEach(function (endpoint) {
